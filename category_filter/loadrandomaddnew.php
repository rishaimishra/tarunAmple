<?php
    ...
    ?>
    <div class="ads-setss">
        <div  id="dd_<?=$displayadd['adver_id'];?>"  class="main-logo"><img  src="<?php echo cdnUrl('adver_images/image/'.$displayadd['adver_logo']);?>"/>
        </div>
        <input type="hidden" name="hiddenvaldd" value="<?=$displayadd['adver_id']?>">
        ...
        <div class="ads-band">
            <h2 class="ads-band-left"><span><?php if($displayadd['view']==''){ echo '0'; }else{
                        echo $displayadd['view']; } ?></span> View</h2>
