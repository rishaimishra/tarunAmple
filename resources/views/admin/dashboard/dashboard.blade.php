                           ...
                           <table class="table">
                              <tbody>
                                 <tr>
                                    <td>
                                       <div class="flag">
                                       <img src="{{url('/')}}/public/adminassets/img/flags/US.png" </div>
                                    </td>
                                    <td>USA</td>
                                    <td class="text-right">
                                       2.920
                                 ...
                                 <tr>
                                    <td>
                                       <div class="flag">
                                       <img src="{{url('/')}}/public/adminassets/img/flags/DE.png" </div>
                                    </td>
                                    <td>Germany</td>
                                    <td class="text-right">
                                       1.300
                                 ...
                                 <tr>
                                    <td>
                                       <div class="flag">
                                       <img src="{{url('/')}}/public/adminassets/img/flags/AU.png" </div>
                                    </td>
                                    <td>Australia</td>
                                    <td class="text-right">
                                       760
                                 ...
                                 <tr>
                                    <td>
                                       <div class="flag">
                                       <img src="{{url('/')}}/public/adminassets/img/flags/GB.png" </div>
                                    </td>
                                 ...
                                 <tr>
                                    <td>
                                       <div class="flag">
                                       <img src="{{url('/')}}/public/adminassets/img/flags/RO.png" </div>
                                    </td>
                                    <td>Romania</td>
                                    <td class="text-right">
                                       600
                                 ...
                                 <tr>
                                    <td>
                                       <div class="flag">
                                       <img src="{{url('/')}}/public/adminassets/img/flags/BR.png" </div>
                                    </td>
                                    <td>Brasil</td>
                                    <td class="text-right">
                                       550
         ...
         <div class="row">
            <div class="col-md-4">
               <div class="card card-product">
                  <div class="card-header card-header-image" data-header-animation="true">
                     <a href="#pablo">
                        <img class="img" src="{{url('/')}}/public/adminassets/img/card-2.jpg">
                     </a>
                  </div>
                  <div class="card-body">
            ...
            <div class="col-md-4">
               <div class="card card-product">
                  <div class="card-header card-header-image" data-header-animation="true">
                     <a href="#pablo">
                        <img class="img" src="{{url('/')}}/public/adminassets/img/card-3.jpg">
                     </a>
                  </div>
                  <div class="card-body">
                     <div class="card-actions text-center">
            ...
            <div class="col-md-4">
               <div class="card card-product">
                  <div class="card-header card-header-image" data-header-animation="true">
                     <a href="#pablo">
                        <img class="img" src="{{url('/')}}/public/adminassets/img/card-1.jpg">
                     </a>
                  </div>
                  <div class="card-body">
                     <div class="card-actions text-center">
