...
{{-- title section --}}
@section('title')
<title>Amplepoint | Category Add</title>
@endsection
{{-- sidebar section --}}
@section('sideber')
	...
	<div class="card">
		...
		<div class="card-body">
			<form method="post" action="{{ route('admin.category.store') }}" enctype="multipart/form-data"
				...
				<!-- Category Banner Image and Additional Category Banner Images in separate rows -->
				{{-- <div class="form-group">
					<label for="inputCategoryBanner">Category Banner Image (746x250 pixels)</label>
					<div class="custom-file">
						<input type="file" accept="image/*" class="custom-file-input" name="category_banner" id="inputCategoryBanner"
						onchange="previewImage(this, 'previewBanner')">
						<label class="custom-file-label" for="inputCategoryBanner">Choose file</label>
					</div>
					<img id="previewBanner" src="" alt="Image Preview" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
				</div> --}}
