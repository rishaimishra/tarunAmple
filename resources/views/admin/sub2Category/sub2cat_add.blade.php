...
{{-- title section --}}
@section('title')
<title>Amplepoint | Sub 2 Category Add</title>
@endsection
{{-- sidebar section --}}
@section('sideber')
...
<div class="col-md-12">
	<div class="card">
		<div class="card-header card-header-rose card-header-text">
			<div class="card-text">
				<h4 class="card-title">Sub 2 Category Add</h4>
			</div>
		...
		<div class="card-body">
			<form method="post" action="{{ route('admin.sub2.category.store') }}" enctype="multipart/form-data"
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="sub2_category_name">
						</div>
					</div>
					<div class="col-md-6">
						<!-- Category Slug -->
						<div class="form-group">
							...
							<input type="text" class="form-control" name="sub2_category_slug">
						</div>
					</div>
...
<br>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="sub2_cat_desc">
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="sub2_meta_title">
						</div>
					</div>
					<div class="col-md-6">
						<!-- Meta Description -->
						<div class="form-group">
							...
							<input type="text" class="form-control" name="sub2_meta_description">
						</div>
					</div>
				</div>
				<!-- Keywords -->
				<div class="form-group">
					...
					<input type="text" class="form-control" name="sub2_meta_keywords">
				</div>
				<br>
				<hr>
				<br>
