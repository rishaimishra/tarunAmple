<script type="text/javascript">
    ...
    function SelectCC(ccnum) {
        ...
        if (first == "4") {
            //Visa
            document.getElementById("mastercard").src = "<?php echo $this->baseUrl(); ?>/images/mastercard-card-bw.png";
            document.getElementById("amex").src = "<?php echo $this->baseUrl(); ?>/images/amex-card-bw.png";
            document.getElementById("discover").src = "<?php echo $this->baseUrl(); ?>/images/discover-card-bw.png";
            document.getElementById("visa").src = "<?php echo $this->baseUrl(); ?>/images/visa-card.png";
            document.getElementById("cctype").value = "1";
        } else if ((first == "3") && ((second == "4") || (second == "7"))) {
            //American Express
            document.getElementById("mastercard").src = "<?php echo $this->baseUrl(); ?>/images/mastercard-card-bw.png";
            document.getElementById("visa").src = "<?php echo $this->baseUrl(); ?>/images/visa-card-bw.png";
            document.getElementById("discover").src = "<?php echo $this->baseUrl(); ?>/images/discover-card-bw.png";
            document.getElementById("amex").src = "<?php echo $this->baseUrl(); ?>/images/amex-card.png";
            ...
            document.getElementById("visa").src = "<?php echo $this->baseUrl(); ?>/images/visa-card-bw.png";
            document.getElementById("discover").src = "<?php echo $this->baseUrl(); ?>/images/discover-card-bw.png";
            document.getElementById("mastercard").src = "<?php echo $this->baseUrl(); ?>/images/mastercard-card.png";
            ...
            document.getElementById("visa").src = "<?php echo $this->baseUrl(); ?>/images/visa-card-bw.png";
            document.getElementById("mastercard").src = "<?php echo $this->baseUrl(); ?>/images/mastercard-card-bw.png";
            document.getElementById("discover").src = "<?php echo $this->baseUrl(); ?>/images/discover-card.png";
