...
width: 14.7%;
    ...
    @media (min-width: 1280px) {
        ...
        .mall-banner #carousel-example-generic .carousel-inner .item,
        #carousel-example-generic.vendor-section-bnr .carousel-inner .item {
                ...
                <div id="carousel-example-generic" class="carousel fadeIn" data-ride="carousel">
                    ...
                    <div id="parallex-div-div">
                        <div class="container">
                            ...
                            <div class="col-lg-3 img-parallax-img-img">
                                <div class="img-parallax">
                                    <div class="top-banner-img-a"><img src="<?php if ($resultonecatbymalllist[0]->logo_image) {
                                        echo $admin_model_obj->cdnUrl('public/mall/logo/' . $resultonecatbymalllist[0]->logo_image);
                                    } else {
                                        echo $admin_model_obj->cdnUrl('public/images/img/user2.jpg');
                                    } ?>" class="imgrounded">
...
<div class="container">
    <div class="content maxxvendor-detail" id="productContainer">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="vendor-div">
                    <ul>
                        <li>
                            <h4><?php echo $key->directory_name; ?> </h4>
                        </li>
                    </ul>
