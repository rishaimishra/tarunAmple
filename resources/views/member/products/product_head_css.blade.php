<head>
	...
	<meta name="keywords" content="GUCCI Gray Gradient Cat Eye Ladies Sunglasses">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<!--  <meta name="viewport" content="width=device-width; initial-scale = 1.0; maximum-scale=1.0; user-scalable=no" />-->
	<meta name="description" content="GUCCI Gray Gradient Cat Eye Ladies Sunglasses">
	...
	<meta property="og:url" content="https://amplepoints.com/productdetail/59090" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="GUCCI Gray Gradient Cat Eye Ladies Sunglasses" />
	<meta property="og:description" content="GET IT FREE WITH :2833.17 Amples
	Price:$339.98
	Buy & Earn:1416.58 Amples
	Reward Value: $169.99
	You Earn:50.00%
	Product By:GUCCI
	" />
...
.fade {
	...
	<style>
	/*.center_column{margin-left:-15px;}*/
	...
	@media (min-width: 640px) {
	.product-onsale .product-list li .left-block {
	max-height: 300px !important;
	min-height: 300px;
	}
	}
	.product-onsale .product-list .owl-item li .left-block img {
	max-height: 300px !important;
	min-height: 300px;
	}
	...
	.primary-box.row.main-produtboxcon .pb-right-column.col-xs-12.col-sm-5 {
	...
	#left_column .product-list li:hover .add-to-cart {
	bottom: 80px;
	margin: 0 auto;
	}
	#left_column .product-list li:hover .price_main {
	bottom: 0px;
	text-decoration: none;
	}
	.by_aria {
	...
	::i-block-chrome, .page-product-box > .product-list .product-container {
	margin-bottom: 0px;
	margin-left: 1px;
	}
	...
	color: #fff !important;
	background-color !important: #ec971f;
	...
	.earn-reward a, .earn-reward a:hover {
	color: #ffffff;
	text-decoration: none;
	}
	.earn-reward-fixed {
	...
	.earn-reward-fixed a, .earn-reward-fixed a:hover {
	color: #ffffff;
	text-decoration: none;
	}
	...
	.delivery li div:hover .fa {
	background: #07253f none repeat scroll 0 0;
	}
	p.kit span {
	padding: 0 0 0 0;
	}
	.product-price-group > p, .info-orther > p {
	color: #333;
	}
	.product-price-group > p.kit {
