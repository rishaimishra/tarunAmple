                                                ...
                                                <div class='col-md-12 col-sm-12 col-xs-12 no-space'>
                                                    ...
                                                    <div class='input-group margin-bottom-sm col-md-7 col-sm-7 col-xs-7'>
                                                        <input type='text' id='itemprice' name='itemprice'
                                                               class='form-control'
                                                               value='<?php echo $this->currencySymbol; ?><?php echo $admin_model_obj->FormatPricingValues($productDetails->single_price); ?>'
                                                               disabled>
                                                ...
                                                <div class='grand-total1 text-center'>
                                                    <div class='col-md-8 col-sm-8 col-xs-8 no-space'
                                                        ...
                                                        <h4 id='newitemprice' style="margin: 15px 10px;">&nbsp;
                                                            <?php echo $this->currencySymbol; ?><?php echo $admin_model_obj->FormatPricingValues($productDetails->single_price); ?></h4>
                                                ...
                                                <div class='grand-total text-center' data-step="4"
                                                    ...
                                                    <script>
                                                        ...
                                                        $("body").on("click", "#cartwithample", function (event) {
                                                            ...
                                                            var product_id = '<?php echo strip_tags($this->main_product_id); ?>';
                                                            ...
                                                            var total_ample = '<?php if (!empty($this->record['data'][0]['total_ample'])) {
                                                                echo $admin_model_obj->DisplayAmplePoints($this->record['data'][0]['total_ample']);
                                                            } else {
                                                                echo "0.00";
                                                            } ?>';

                                                            var usrmakey = '<?php echo $this->usrmakey; ?>';
                                                        ...
                                                        if ($AvailableQuantity > 0) {
                                                            ...
                                                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                                                ...
                                                                <div class='button-group' id='btax'><a
                                                                            class='btn-add-cart' id="cartwithoutample"
