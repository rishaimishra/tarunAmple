                    ...
                    <div class="pro_discription">
                        <div class="col-sm-4 pad0" id="borderright">
                            <div class="content_price4">
                                <p>Your Price</p>
                                <span><?php echo $pro['discount_price_without_ample']; ?> </span>
                            </div>
                        </div>
                        <div class="col-sm-5 pad0" id="borderright">
                            <div class="price7">
                                <p>Selling Price</p>
                                <span class="wholesale"><?php echo $currencySymbol; ?><?php echo $pro['single_price']; ?></span>
                        ...
                        <div class="col-sm-3 align">
                            <div class="save5">
                                <p>Discount</p>
                                <span><?php echo (int)($pro['discount_without_ample']); ?>%</span>
                            </div>
                        </div>
                    </div>
                    <div class="pro_price">
                        <div class="price2"><a
                                    href="#"><?php echo $currencySymbol; ?><?php echo $pro['discount_price_without_ample']; ?></a>
                        </div>
                        <div class="by_aria">
                            <?php $vendorName1 = strtolower(preg_replace('/\s+/', '', $pro['supplier_name'])); ?>
                            <a href="<?php echo $baseurl . '/productbyseller/' . $vendorName1 . '/' . $pro['vendor_uid']; ?>"><?php echo substr($pro['supplier_name'], 0, 15); ?></a>
                            <h6>By:&nbsp;</h6>
                        </div>
                ...
                <div class="filter-data">
                    ...
                    <div class="pro_discription">
                        ...
                        <div class="col-sm-5 pad0" id="borderright">
                            <div class="price7">
                                <p>Reward value</p>
                                <span><?php echo $currencySymbol; ?><?php echo $pro['discount_price']; ?></span>
                    ...
                    <div class="pro_price">
                        <div class="price2"><a
                                    href="#"><?php echo $currencySymbol; ?><?php echo $pro['single_price']; ?></a></div>
                        <div class="by_aria">
                            <?php $vendorName1 = strtolower(preg_replace('/\s+/', '', $pro['supplier_name'])); ?>
                            <a href="<?php echo $baseurl . '/productbyseller/' . $vendorName1 . '/' . $pro['vendor_uid']; ?>"><?php echo substr($pro['supplier_name'], 0, 15); ?></a>
                            <h6>By:&nbsp;</h6>
                        ...
                        <div class="add-to-cart">
                            <a title="Add to Cart" href="<?php echo $baseurl . '/productdetail/' . $pro['id']; ?>">Add
                                to Cart</a>
                        </div>
                    </div>
            </li>
