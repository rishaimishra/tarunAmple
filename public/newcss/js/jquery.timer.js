...
(function( $ ){
	cyntax.plugins.timer = function( ele , options ){
		...
		this.timer_info = {id:null, indexx:null, state:0};
	};
	cyntax.plugins.timer.prototype = {
		...
		_timer_fn : function() {
				if (typeof this.options.callback == "function")
					$.proxy( this.options.callback, this.$this ).call(this, ++this.timer_info.indexx);
				...
				if ( this.options.repeat && this.timer_info.state == 1 &&
					(typeof this.options.repeat == "boolean" || parseInt(this.options.repeat) > this.timer_info.indexx) )
					this.timer_info.id = setTimeout( $.proxy( this._timer_fn, this ) , this.options.delay );
				else
					this.timer_id = null;
		},
